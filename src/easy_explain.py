...
def run_easy_explain(model, image_url, total_preds, vis_types=[["blended_heat_map", "original_image"]], vis_signs = [["all","all"]], labels_path: str =  'imagenet_class_index.json', target=None):
